  ...
  walkStores(buildOptions.storesFolder, (err, stores) => {
    ...
    for (i = 0; i < _storeNames.length; i++) {
      ...
      try {
        ...
        var _refDescriptor  = { references : _compilation.filtersFn , getPrimaryKeyFns : {}, collections : {} };
        ...
        for (let referencedStore in _compilation.meta.references) {
          ...
          _refDescriptor.getPrimaryKeyFns[referencedStore] = '_' + (_sanitizePath(referencedStore)) + '.getPrimaryKeyFn';
        }
