      ...
      exports._registerFilterHooks = function () {
        for (i = 0; i < exports.filters.length; i++) {
          ...
          if (exports.filters[i].isAutoUpdate === undefined || exports.filters[i].isAutoUpdate === true) {
            lunaris.hook('update@' + exports.filters[i].name, _handler);
            lunaris.hook('insert@' + exports.filters[i].name, _handler);
            lunaris.hook('reset@'  + exports.filters[i].name, _handler);
          }
        }
      };
    `;
