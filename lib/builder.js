    ...
    for (var i = 0; i < stores.length; i++) {
      try {
        ...
        if (_storeCodeEval.map) {
          ...
          var _storesToJoin    = Object.keys(_meta.meta.joins);
          var _collectionJoins = { joins : _meta.meta.joins, joinFns : _meta.meta.getJoinFns };
          for (var k = 0; k < _storesToJoin.length; k++) {
            ...
            _collectionJoins['collections'][_storesToJoin[k]] = 'lunaris._stores[\'' + _storesToJoin[k] + '\'].data';
          }

          _storeCode += '\nexports["joins"] = ' + JSON.stringify(_collectionJoins) + ';';
        }
        else {
